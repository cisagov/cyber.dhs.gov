...
<div class="usa-alert usa-alert-info" >
  <div class="usa-alert-body">
    ...
    <p>
    <b>UPDATE (Dec. 23): The deadline for submitting comments is 11:59 PM EST on <strike>December 27, 2019</strike> January 10, 2020</b>.
    </p>
    <p>
...
about such issues shared by non-system owners. Only a few agencies have
...
maintaining or enhancing their security, safety and privacy.
...
the public\'s wellbeing are turned away:
...
Within 90 business days after the issuance of this directive, update the
...
2.  The "Organization" field for each .gov domain registered. The field
    ...
    3.  Create a [security.txt](https://datatracker.ietf.org/doc/draft-foudil-securitytxt/)[^15] file at the "/.well-known/" path[^16] of
    ...
    4.  Within 270 calendar days after the issuance of this directive, and
    within every 90 calendar days thereafter, the scope of the VDP must
    
    5.  At 2 years after the issuance of this directive, all
...
{:start="5"}
6.  All newly launched internet-accessible systems or services must be
...
8.  Develop or update vulnerability disclosure handling procedures to
    ...
    a)  Describe how[^19]:
      ...
      >vi. Actual, past impact (i.e., not those that occurred in the
            ...
            and treated as an incident, per the agency incident response plans.
...
-   CISA will not submit any vulnerabilities it receives or help
