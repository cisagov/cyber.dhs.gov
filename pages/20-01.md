...
### VDP template
To make it easier for your agency to begin, we’ve created a [VDP template]({{ site.baseurl }}/bod/20-01/vdp-template) which has been written to align with the Department of Justice’s [Framework for a Vulnerability Disclosure Program for Online Systems](https://www.justice.gov/criminal-ccips/page/file/983996/download). The document is also available as a [Word document]({{ site.baseurl }}/assets/report/bod-20-01-vdp-template.docx).
