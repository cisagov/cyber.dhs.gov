...
<div class="usa-alert usa-alert-info" >
  <div class="usa-alert-body">
    ...
    <p>
    CISA has posted this draft policy for public feedback. You may contribute in three ways:
    </p>
    <p>
...
This page contains a web-friendly version of the Cybersecurity and Infrastructure Security Agency's [Binding Operational Directive 20-01 (draft) ]({{ site.baseurl }}/assets/report/bod-20-01-draft.pdf), _Develop and Publish a Vulnerability Disclosure Policy_.
...
#### Craft a policy
To support good practices and make it easier for your agency to begin, we’ve created a [VDP template]({{ site.baseurl }}/assets/report/bod-20-01-vdp-template.docx).
