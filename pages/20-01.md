...
<div class="usa-alert usa-alert-info" >
  <div class="usa-alert-body">
    ...
    <p>
    CISA has posted this draft directive, <a href="{{ site.baseurl }}/bod/20-01/#implementation-guide">directive guidance</a>, and a <a href="/bod/20-01/vdp-template">VDP template</a> for public feedback. You may contribute in three ways:
    </p>
    <p>
...
### Craft a policy
To support good practices and make it easier for your agency to begin, we’ve created a [VDP template](/bod/20-01/vdp-template).
