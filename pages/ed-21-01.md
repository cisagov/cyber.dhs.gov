...
Update: _December 29, 2020_

This section supplements Emergency Directive 21-01 and Supplemental Guidance issued on December 18, 2020.
...
CISA will follow up with additional supplemental guidance, to include further clarifications and hardening requirements.

  |   **Orion Platform Version**    | **Continued use of SolarWinds Orion permitted at this time** | **Update required?** |
  | ----------- | -------- | ---------------- |
  | Affected versions: 2019.4 HF5, 2020.2 RC1, 2020.2 RC2, 2020.2, 2020.2 HF1 (must be powered down or removed from networks based on ED 21-01) | **No** | N/A |
