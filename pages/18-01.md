...
Based on discussions with Federal agency leaders and industry representatives, DHS acknowledges that there is a significant constraint around disabling the weak email cipher 3DES. As a result, DHS is hereby issuing a [temporary policy exception on the BOD requirement related to disabling the weak email cipher 3DES.](https://cyber.dhs.gov/assets/report/<BOD_18-01_Letter_for_Temporary_Exception_to_Agencies_FINAL_v1_Signed.pdf)
