...
---
**See [updated supplemental direction](#supplemental-direction) for the latest.**
...
For each agency, department-level Chief Information Officers (CIOs) or equivalents shall submit two additional status reports to CISA using the provided template to <CyberDirectives@cisa.dhs.gov>.
